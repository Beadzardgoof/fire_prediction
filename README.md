...
| Feature | Data Type | Notes | Source |
|---------|-----------|-------|--------|
| Season | 2 numeric features (sin/cos) | Encodes circularity of seasons | Derived from date |
...
| Feature | Data Type | Notes | Source |
|---------|-----------|-------|--------|
| Start time | Float / datetime | Timestamp or numeric hours since reference | MODIS/VIIRS detection dataset |
| End time | Float / datetime | Timestamp or numeric hours | MODIS/VIIRS detection dataset |
| Ignition probability | Float (0–1) | Scaled confidence from satellite detection | MODIS/VIIRS confidence column |
